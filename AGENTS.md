...
This file is the quick-reference operating contract for two-face-kotlin. The longer
...
two-face-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`two-face`](https://crates.io/crates/two-face). Upstream Rust is the behavioral oracle while the
