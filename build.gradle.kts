...
kotlin {
    ...
    val xcf = XCFramework("TwoFace")

    macosArm64 {
        binaries.framework { baseName = "TwoFace"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TwoFace"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TwoFace"
        flattenPackage = "io.github.kotlinmania.twoface"
    }

    android {
        namespace = "io.github.kotlinmania.twoface"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "two-face-kotlin", version.toString())

    pom {
        name.set("two-face-kotlin")
        description.set("Kotlin Multiplatform port of CosmicHorrorDev/two-face - Extra syntax and theme definitions for syntect")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/two-face-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/two-face-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/two-face-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/two-face-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTwoFaceXCFramework",
    "assembleTwoFaceDebugXCFramework",
    "assembleTwoFaceReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTwoFaceXCFramework",
    "assembleReleaseIosFatFrameworkForTwoFaceXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTwoFaceXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTwoFaceXCFramework",
    "assembleDebugMacosFatFrameworkForTwoFaceXCFramework",
    "assembleReleaseMacosFatFrameworkForTwoFaceXCFramework",
    "assembleDebugTvosFatFrameworkForTwoFaceXCFramework",
    "assembleReleaseTvosFatFrameworkForTwoFaceXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTwoFaceXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTwoFaceXCFramework",
    "assembleDebugWatchosFatFrameworkForTwoFaceXCFramework",
    "assembleReleaseWatchosFatFrameworkForTwoFaceXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTwoFaceXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTwoFaceXCFramework",
